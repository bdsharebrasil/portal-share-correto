      ...
      const { data: insertedEntry, error } = await supabase.from('logbook_entries').insert([
        {
          ...
          ac_time: toNumericOrNull(formData.ac_time),
          dep_time: toNumericOrNull(formData.departure_time),
          pou_time: toNumericOrNull(formData.pou_time),
          cor_time: toNumericOrNull(formData.cor_time),
          crew_checkin_time: toNumericOrNull(formData.crew_checkin_time),
          time: flightTime,
