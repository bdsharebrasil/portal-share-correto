  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const serviceOrderData = {
        ...
        total_geral: formData.total_mao_obra || formData.total_pecas
          ? (parseFloat(formData.total_mao_obra || "0") + parseFloat(formData.total_pecas || "0"))
          : null,
      };
      ...
      onServiceOrderCreated?.(data as CTMServiceOrder);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="os_oficina">Código da Oficina (SAC)</Label>
                <Input
                  id="os_oficina"
                  placeholder="Ex: SAC-12345"
                  value={formData.os_oficina}
                  onChange={(e) => handleChange("os_oficina", e.target.value)}
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <Input
                  id="oficina_nome"
                  placeholder="Ex: Avionics Brasil"
              ...
              <div>
                ...
                <Input
                  id="oficina_contato"
                  placeholder="Ex: (11) 98765-4321 ou contato@oficina.com"
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange("dias_previstos", e.target.value)}
                  min="0"
                  step="1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  type="number"
                  placeholder="Ex: 4"
                  value={formData.dias_efetivos}
                  onChange={(e) => handleChange("dias_efetivos", e.target.value)}
                  min="0"
                  step="1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange("horas_celula", e.target.value)}
                  min="0"
                  step="0.5"
                />
              </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                id="objetivo"
                placeholder="Descreva o objetivo desta manutenção..."
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange("total_mao_obra", e.target.value)}
                  min="0"
                  step="0.01"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange("total_pecas", e.target.value)}
                  min="0"
                  step="0.01"
                />
              </div>
