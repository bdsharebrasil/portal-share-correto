...
import { AircraftCard } from '@/components/dashboard/operador/AircraftCard';
import { StatusCard } from '@/components/dashboard/operador/StatusCard';
import { MaintenanceList } from '@/components/dashboard/operador/MaintenanceList';
import { ComponentLifeCard } from '@/components/dashboard/operador/ComponentLifeCard';
