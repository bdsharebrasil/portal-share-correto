...
export function CTMAircraftDetail({
  ...
  const filteredOrders = categoryFilter === "TUDO" ? serviceOrders : serviceOrders.filter(o => o.tipo_manutencao === categoryFilter);
  ...
  return <div className="space-y-6">
      ...
      y: 0
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          scale: 0.95
        }} onClick={onBack} className="p-3 rounded-xl bg-background/80 border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
          ...
          {activeTab === "os" && <motion.div initial={{
          opacity: 0,
          scale: 0.8
        }} animate={{
          opacity: 1,
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
        ...
        const Icon = tab.icon;
        return <motion.button key={tab.value} initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
      ...
      <AnimatePresence mode="wait">
        ...
        duration: 0.2
          ...
          {/* OS Tab */}
          {activeTab === "os" && <div className="space-y-6">
              ...
              <Card className="border-border/50 bg-background/50 backdrop-blur-sm">
                <CardContent className="p-4">
                  ...
                  return <motion.button key={cat.value} whileHover={{
                    scale: 1.03
                  }} whileTap={{
                    scale: 0.97
                  }} onClick={() => setCategoryFilter(cat.value)} className={cn("px-4 py-2 rounded-lg font-medium text-sm transition-all border", isActive ? `${colors.bg} ${colors.border} ${colors.text} shadow-lg ${colors.glow}` : "bg-muted/30 border-border/50 text-muted-foreground hover:bg-muted/50")}>
                          {cat.label}
                        </motion.button>;
                })}
              ...
              {partnerHours.length > 0 && <motion.div initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            y: 0
              ...
              {/* Service Orders List */}
              {loadingOS ? <div className="flex items-center justify-center py-12">
                  <motion.div animate={{
              rotate: 360
            }} transition={{
              duration: 2,
              ...
              ease: "linear"
                ...
                </div> : filteredOrders.length === 0 ? <motion.div initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }}>
                              ...
                              <div className="flex-1 p-4 flex items-start justify-between">
                                ...
                                <div className="text-right">
                                  ...
                                  <p className="text-2xl font-black text-foreground">
                                    R$ {(order.total_geral || 0).toLocaleString("pt-BR", {
