...
export function FormDespesasEmpresa({ form, setForm, fornecedores }: Props) {
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-semibold text-primary uppercase tracking-wide">Despesas Empresa</h3>
      <FornecedorSelect
