    ...
    <div className="flex flex-col md:flex-row pt-16 min-w-0">
      ...
      <main className="flex-1 w-full md:pl-20 p-4 md:p-6 custom-scrollbar overflow-x-auto overflow-y-auto transition-all duration-300">
        <div className="min-h-full flex flex-col min-w-0">
          <div className="bg-gradient-to-br from-slate-800/80 via-slate-850/75 to-slate-900/80 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-700/50 overflow-hidden w-full">
            <div className="min-w-0 w-full -mx-[5px] px-0 py-[21px]">
              {children}
            </div>
          </div>
        </div>
