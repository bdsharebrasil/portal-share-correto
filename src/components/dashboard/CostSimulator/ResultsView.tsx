      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
        <Card className="bg-gradient-to-br from-amber-500/15 to-amber-600/5 border-amber-500/30">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-muted-foreground mt-3">Distância: {costs.distanceNm} NM ({costs.distanceKm} km)</p>
          </CardContent>
        </Card>
        ...
        <section>
          ...
          <Card className="bg-card-secondary/40 border-border/60">
            <CardContent className="p-4 space-y-2">
              ...
              <div className="border-t border-border/60 pt-2 mt-2 flex justify-between text-sm">
                <span className="text-muted-foreground font-medium">Subtotal fixo</span>
        ...
        <section>
          ...
          <Card className="bg-card-secondary/40 border-border/60">
            <CardContent className="p-4 space-y-2">
              ...
              <div className="border-t border-border/60 pt-2 mt-2 flex justify-between text-sm">
                <span className="text-muted-foreground font-medium">Subtotal variável</span>
...
function Stat({ icon, label, value }: { icon: React.ReactNode; label: string; value: string }) {
  return (
    <div className="rounded-lg bg-card/40 border border-border/40 p-2">
