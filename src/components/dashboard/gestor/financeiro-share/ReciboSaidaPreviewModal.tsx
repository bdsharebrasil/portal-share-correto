...
export const ReciboSaidaPreviewModal: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 p-4">
      <div className="flex h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-border bg-background">
        <div className="flex items-center justify-between border-b border-border px-5 py-3">
          <div>
            <h3 className="text-sm font-bold text-foreground">Prévia do Recibo de Saída</h3>
        ...
        <div className="flex-1 overflow-auto bg-card/60 p-4">
          {generating ? (
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 border-t border-border px-5 py-3">
          ...
          <button
            onClick={download}
            disabled={!pdfUrl}
            className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-card/70 px-3 py-2 text-sm text-foreground hover:bg-card-secondary disabled:opacity-50"
          >
