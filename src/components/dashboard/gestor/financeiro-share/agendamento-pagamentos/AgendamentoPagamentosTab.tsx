...
export function AgendamentoPagamentosTab() {
  const { user } = useAuth();
    ...
    <div className="space-y-6">
      ...
      {upcomingPayments.length > 0 && (
        <Alert className="border-amber-500/50 bg-amber-500/10">
          ...
          <AlertDescription className="text-amber-400">
            Você tem <strong>{upcomingPayments.length}</strong> pagamento(s) nos próximos 7 dias.
          </AlertDescription>
        </Alert>
      )}
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button variant="outline" size="sm" onClick={() => handleEdit(agendamento)}>
      ...
      <Dialog open={!!deleteConfirmId} onOpenChange={(open) => !open && setDeleteConfirmId(null)}>
        <DialogContent>
          ...
          <p className="text-muted-foreground">Deseja realmente deletar este agendamento?</p>
          <DialogFooter>
