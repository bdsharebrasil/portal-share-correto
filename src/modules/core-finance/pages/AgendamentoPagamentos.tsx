...
import { fetchAgendamentos, deleteAgendamento, markAgendamentoAsPaid } from "@/modules/core-finance/services/agendamentos";
...
export default function AgendamentoPagamentos() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteAgendamento(deleteConfirmId);
  ...
  const handleMarkAsPaid = async (agendamento: any) => {
    try {
      await markAgendamentoAsPaid(agendamento, user?.id);
