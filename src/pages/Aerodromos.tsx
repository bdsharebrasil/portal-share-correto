        ...
        <header className="space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-slate-400 mt-2">Base de dados geográfica para cálculos de navegação.</p>
            </div>
          ...
          <div className="relative group max-w-md">
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-800 rounded-2xl py-3 pl-12 pr-4 text-slate-200 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition-all shadow-xl"
            />
          </div>
        </header>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filteredData.map((a: any) => (
              <div key={a.id} className="bg-slate-900 border border-slate-800 rounded-2xl p-4 hover:border-slate-700 transition-all shadow-lg group">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex gap-1.5 opacity-0 group-hover:opacity-100 transition-all">
                    <button
                      ...
                      className="p-1.5 bg-slate-800 rounded-lg hover:text-sky-400 transition-colors"
                      title="Editar"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 bg-slate-800 rounded-lg hover:text-red-400 transition-colors"
                      title="Excluir"
                    >
                ...
                <div className="bg-slate-950/50 rounded-xl p-3 flex items-center gap-3">
                  ...
                  <div className="flex-1 overflow-hidden">
                    <p className="text-[9px] text-slate-600 font-black uppercase tracking-wider">Coordenadas DMS</p>
