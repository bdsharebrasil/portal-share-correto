 ...
 *
 * 作Exemplo do erro:
 * - Voo de 21:10-22:18 UTC com pôr real às 22:12 UTC
 * - Função errada calculava como parcialmente noturno
 * - Função correta calcula corretamente baseado em dados solares reais
 *
 * @param entry Dados do voo (dep_time, pou_time, total_time)
 * @returns Object com day_time e night_time (INCORRETO - não usar)
 */
