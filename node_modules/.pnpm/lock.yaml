...
dependencies:
  '@hookform/resolvers':
    specifier: ^3.9.0
    version: 3.10.0(react-hook-form@7.72.0)
  ...
  react-router-dom:
    specifier: ^7.13.1
    version: 7.13.2(react-dom@19.2.4)(react@19.2.4)
  react-window:
    specifier: ^1.8.10
...
packages:
  ...
  /@hookform/resolvers@3.10.0(react-hook-form@7.72.0):
  ...
  /@typescript-eslint/eslint-plugin@8.57.2(@typescript-eslint/parser@8.57.2)(eslint@9.39.4)(typescript@5.9.3):
  ...
  /supabase@2.84.3:
    resolution: {integrity: sha512-Oz52uw7yHrLEegHvya5+tChbM24m+AOTlZxPoVy3LWEztfhGlixGUs/cyul4pugEp7S6uktzh/pW8udgUbPHog==}
    engines: {npm: '>=8'}
    hasBin: true
    requiresBuild: true
    dependencies:
